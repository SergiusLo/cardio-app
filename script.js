...
// const cycling = new Cycling([50, 39], 7, 50, 349);
...
class App {
  ...
  constructor() {
    ...
    this._getPosition();
    //Поулчение данных из local storage
  ...
  _loadMap(position) {
    ...
    //Отображение тренировок на карте из локал сторедж
  ...
  _newWorkout(event) {
    ...
    //Если тренировка являеться пробежкой создать объект Cycling
    if (type === 'cycling') {
    ...
    //Отобразить тренировоку на карте
    this._displayWorkout(workout);

    //Отразить тренировку в списке
